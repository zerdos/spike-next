...
A: We don't publish prices, and I can't quote them. The assessment is fixed-fee and the pilot fixed-scope; Zoltan discusses numbers on a discovery call.

**Q: How long does an assessment take?**
A: One to two weeks, fixed fee.

**Q: How fast can a pilot ship?**
...
**Q: Are you a chatbot vendor?**
A: No. Chatbots are interfaces; we build agentic systems — software that plans and executes work inside your delivery pipeline. This chat happens to be one such system.

**Q: Do you replace our developers?**
A: No. We make them faster: agents carry the repetitive load, your engineers direct and own the output. Team enablement is one of our four services.
...
A: The method is industry-agnostic; the founder's deepest experience is telecoms, banking, and consumer-facing platforms.
